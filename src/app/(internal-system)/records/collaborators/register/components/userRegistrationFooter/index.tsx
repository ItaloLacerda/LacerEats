...
import { boxStyle, textFieldStyle, buttonStyle } from '@/styles/pages/(internal-system)/records/collaborators/register/components/UserRegistrationFooter.style'
import { Box, Button, FormControl, InputLabel, MenuItem, Select, type SelectChangeEvent } from '@mui/material'
import * as React from 'react'

export default function UserRegistrationFooter () {
